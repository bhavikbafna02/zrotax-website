    ...
    return (
        <div className="container py-12 md:py-24 space-y-20">
            ...
            <section className="text-center max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="inline-flex items-center rounded-full border border-border px-3 py-1 text-sm font-medium text-foreground bg-muted mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
                    <Button asChild size="lg" className="h-14 px-8 text-lg bg-ring text-white hover:bg-ring/90 shadow-lg hover:shadow-xl transition-all flex items-center justify-center">
                        <Link href="/contact">
                            Book Appointment <ArrowRight className="ml-2 h-5 w-5" />
                        </Link>
                    </Button>
                    <Button asChild variant="outline" size="lg" className="h-14 px-8 text-lg border-border text-foreground hover:bg-accent transition-all flex items-center justify-center">
            ...
            <section className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                {[
                    ...
                    <Card key={i} className="bg-card border border-border text-center hover:shadow-md transition-all">

...
import { ArrowRight, Calculator, Globe, LineChart, ShieldCheck, Users } from "lucide-react";
...
const services = [
    {
        ...
        icon: LineChart,
        features: ["Set realistic financial goals", "Create a budget that works for you", "Develop a comprehensive savings plan", "Invest your money wisely", "Protect your assets with insurance"],
        cta: "Start Planning"
    },
    {
        id: "tax-planning",
        ...
        icon: Calculator,
        features: ["Analyze your current tax situation", "Identify tax-saving opportunities", "Develop a tax-efficient future roadmap", "Accurate and timely return filing", "Resolve Income Tax issues"],
        cta: "Optimize Taxes"
    },
    {
        id: "gst-services",
        ...
        icon: Globe,
        features: ["GST Registration", "Obtain LUT (Letter of Undertaking)", "File GSTR-1 & GSTR-3B", "Maintain Export Documents", "Reconciliation & Zero-rated supplies"],
    ...
    },
    {
        ...
        icon: Users,
        features: ["HUF Formation & Registration", "Manage HUF Affairs", "Tax Benefits (Section 80C deductions)", "Separate Income Tax Slab benefits", "Manage Property & Business Income"],
        cta: "Plan HUF"
    }
];
                ...
                {services.map((service) => (
                    <StaggerItem key={service.id}>
                        <HoverCard className="h-full">
                            <Card className="flex flex-col h-full border-border hover:border-primary/50 transition-colors shadow-sm hover:shadow-lg bg-card">
                                <CardHeader>
                            ...
                            {[
                                ...
                                <StaggerItem key={i}>
                                    <div className="relative flex flex-col items-center text-center space-y-4">
                                        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-card border-2 border-border text-xl font-bold text-primary shadow-sm hover:border-ring hover:scale-110 transition-all duration-300 cursor-default">
                                            {step.icon}
                                        </div>

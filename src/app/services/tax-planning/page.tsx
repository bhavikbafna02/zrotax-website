        ...
        <div className="container py-12 md:py-24 space-y-16">
            <div className="space-y-4">
                <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    <ChevronRight className="h-4 w-4 mx-2" />
                    <span className="font-medium text-primary">Tax Planning</span>
                </div>
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl text-primary">Strategic Tax Planning</h1>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                <div className="space-y-6">
                    <h2 className="text-3xl font-bold text-primary">Why Tax Planning Matters</h2>
                ...
                <div className="bg-muted p-8 rounded-xl border shadow-sm">
                    <h3 className="text-2xl font-bold text-primary mb-6">Our Tax Services Include:</h3>
                    <ul className="space-y-3">
                        <li className="p-3 bg-background rounded-lg border">Corporate Tax Planning & Filing</li>
                        <li className="p-3 bg-background rounded-lg border">Individual Income Tax Solutions</li>
                        <li className="p-3 bg-background rounded-lg border">International Taxation Advisory</li>
                        <li className="p-3 bg-background rounded-lg border">Transfer Pricing Studies</li>
                        <li className="p-3 bg-background rounded-lg border">Tax Dispute Resolution</li>
                    </ul>
                </div>
            </div>

            <div className="bg-primary text-primary-foreground rounded-2xl p-8 md:p-12 text-center space-y-6">
                <h2 className="text-3xl font-bold">Ready to Optimize Your Taxes?</h2>

        ...
        <div className="container relative z-10 flex flex-col items-center gap-8 text-center lg:flex-row lg:text-left lg:justify-between">
          ...
          <div className="flex items-center justify-center lg:w-1/2">
            <div className="relative w-full max-w-lg aspect-square bg-muted/30 rounded-full flex items-center justify-center border border-border/50 shadow-2xl">
              ...
              <div className="text-center space-y-2 p-8 bg-background/80 backdrop-blur rounded-2xl border border-border shadow-lg max-w-sm">
                <h3 className="text-2xl font-bold text-primary">₹1.5 Crores+</h3>
      ...
      <section className="py-12 bg-primary text-primary-foreground">
        <div className="container grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="space-y-2">
            ...
            <p className="text-primary-foreground/80 font-medium">Returns Filed</p>
          </div>
          <div className="space-y-2">
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-ring">500+</h3>
            <p className="text-primary-foreground/80 font-medium">Active Subscriptions</p>
          </div>
          <div className="space-y-2">
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-ring">5000+</h3>
            <p className="text-primary-foreground/80 font-medium">Satisfied Clients</p>
          </div>
          <div className="space-y-2">
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-ring">150+</h3>
            <p className="text-primary-foreground/80 font-medium">Lakhs Taxes Saved</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-32">
        <div className="container text-center space-y-12">
          <div className="space-y-4 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-primary">Why Choose Zrotax?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group p-8 rounded-2xl border bg-card hover:bg-accent/50 transition-all duration-300 space-y-4 text-left">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <div className="bg-primary dark:bg-background rounded-3xl p-8 md:p-16 text-center space-y-8 relative overflow-hidden text-primary-foreground dark:text-foreground ring-1 ring-border">
            ...
            <div className="absolute top-0 left-0 w-64 h-64 bg-ring/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-background/10 rounded-full blur-3xl translate-x-1/2 translate-y-1/2"></div>
          </div>
        </div>
      </section>
    </div>

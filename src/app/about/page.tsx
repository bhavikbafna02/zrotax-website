    ...
    return (
        <div className="container py-12 md:py-24 space-y-20">
            ...
            <section className="grid md:grid-cols-2 gap-8">
                <Card className="bg-card border border-ring/30 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-16 bg-ring/5 rounded-full blur-3xl -mr-16 -mt-16"></div>
            ...
            <section className="space-y-12">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center text-center p-6 rounded-xl border border-border bg-card hover:shadow-lg transition-all duration-300">
            ...
            <section className="space-y-12">
                ...
                <div className="grid gap-8 md:grid-cols-3 justify-center">
                    {[
                        ...
                        <div key={i} className="group relative overflow-hidden rounded-2xl border border-border bg-card text-card-foreground shadow-sm hover:shadow-md transition-all">
